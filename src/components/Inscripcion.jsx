export const Inscripcion = () => {
    return (
        <div className="h-screen text-center flex flex-col items-center justify-center gap-8 ">
            <div className="bg-primary rounded-2xl h-1/2 w-3/4 flex flex-col items-center justify-center gap-5 shadow-2xl">
