    ...
    return (
        <div id="inscripcion">
            ...
            <div className="bg-linear-to-br from-primary to-[#FFB300] rounded-2xl h-1/2 w-3/4 flex flex-col items-center justify-center gap-5 shadow-2xl">
                <h2 className="md:text-6xl text-4xl text-brown font-semibold text-center  ">¿Querés conocer nuestra <br/> casa de aprendizaje?</h2>
                <p className="md:text-lg text-base text-brown text-center">Inscribí a tu hijo en el ciclo lectivo 2024. Quedan pocas vacantes disponibles para las salas de 2 y 3 años.</p>
